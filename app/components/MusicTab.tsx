        ...
        PRO
                ...
                <div className="flex items-center gap-4 text-xs text-[#8d7d6e] mt-3">
                  ...
                  <a href={`https://www.last.fm/user/${USERNAME}`} target="_blank" rel="noopener noreferrer"
                     className="flex items-center gap-1 text-[#b5825f] hover:text-foreground font-medium">
            ...
            <div className="lg:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-gradient-to-br from-[#251911] to-[#1d130d] border border-[#352519] rounded-xl p-4 hover:scale-105 transition-transform">
                ...
                <p className="text-xl font-black text-foreground">{formatShort(totalScrobbles)}</p>
              ...
              <div className="bg-gradient-to-br from-[#241811] to-[#1c130c] border border-[#352519] rounded-xl p-4 hover:scale-105 transition-transform">
                ...
                <p className="text-xl font-black text-foreground">{formatShort(stats.artists)}</p>
              ...
              <div className="bg-gradient-to-br from-[#231810] to-[#1f160f] border border-[#352519] rounded-xl p-4 hover:scale-105 transition-transform">
                ...
                <p className="text-xl font-black text-foreground">{formatShort(stats.albums)}</p>
                <p className="text-xs text-[#8d7d6e]">Álbuns</p>
              </div>
              <div className="bg-gradient-to-br from-[#231810] to-[#1f160f] border border-[#352519] rounded-xl p-4 hover:scale-105 transition-transform">
                <ListMusic className="w-6 h-6 text-[#b5825f] mb-2" />
                <p className="text-xl font-black text-foreground">{formatShort(stats.tracks)}</p>
...
>
  ...
  className="text-[#b5825f] hover:text-foreground transition-colors"
>
...
/>
      ...
      <div className="absolute top-3 right-3 z-10">
        <div className="px-2.5 py-0 rounded-full bg-black/60 backdrop-blur-sm text-foreground text-[10px] font-medium flex items-center gap-1">
...
/>
            ...
            <div className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="flex items-center gap-1 text-foreground text-[10px] font-medium">
            ...
            <div className="absolute top-1.5 left-1.5">
              <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-black/60 backdrop-blur-sm text-foreground text-[10px] font-medium">
                {index + 4}
              </span>
            </div>
          </div>
